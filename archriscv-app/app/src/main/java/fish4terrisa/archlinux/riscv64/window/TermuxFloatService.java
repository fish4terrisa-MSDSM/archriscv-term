...
public class TermuxFloatService extends Service {
    ...
    public static final String ACTION_HIDE = "fish4terrisa.archlinux.riscv64.hide";
    public static final String ACTION_SHOW = "fish4terrisa.archlinux.riscv64.show";

    /**
     * Note that this is a symlink on the Android M preview.
     */
    @SuppressLint("SdCardPath")
    public static final String FILES_PATH = "/data/data/fish4terrisa.archlinux.riscv64/files";
    public static final String PREFIX_PATH = FILES_PATH + "/environment";
    public static final String HOME_PATH = FILES_PATH ;
    ...
    private int MIN_FONTSIZE;private static final int MAX_FONTSIZE = 256;
    ...
    private void setupNotificationChannel() {
        String channelName = "ArchLinux-riscv64";
        String channelDescription = "Notifications from ArchLinux-riscv64";
