...
public final class TerminalService extends Service implements SessionChangedCallback {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "fish4terrisa_archlinux_riscv64_notification_channel";
    private static final int NOTIFICATION_ID = 1338;

    private static final String ACTION_STOP_SERVICE = "fish4terrisa.archlinux.riscv64.service_stop";
    private static final String ACTION_LOCK_WAKE = "fish4terrisa.archlinux.riscv64.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "fish4terrisa.archlinux.riscv64.service_wake_unlock";
	...
	environment.add("CONFIG_DISK_TYPE=" + prefs.getString(getResources().getString(R.string.disk_type_key), "nvme"));
	...
	int actionIcon = wakeLockHeld ? R.mipmap.ic_launcher : R.mipmap.ic_launcher;
