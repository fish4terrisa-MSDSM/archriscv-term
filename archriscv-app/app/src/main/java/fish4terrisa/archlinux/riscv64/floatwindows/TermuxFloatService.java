...
import fish4terrisa.archlinux.riscv64.floatwindows.FloatView;

import java.io.File;

public class TermuxFloatService extends Service {

    private static final String NOTIFICATION_CHANNEL_ID = "archriscv_term_notification_channel";

    public static final String ACTION_HIDE = "fish4terrisa.archlinux.riscv64.floatwindows.hide";
    public static final String ACTION_SHOW = "fish4terrisa.archlinux.riscv64.floatwindows.show";

    /**
     * Note that this is a symlink on the Android M preview.
     */
    @SuppressLint("SdCardPath")
    public static final String FILES_PATH = "/data/data/fish4terrisa.archlinux.riscv64";
    public static final String PREFIX_PATH = FILES_PATH + "/lib";
    public static final String HOME_PATH = FILES_PATH + "/lib";
     ...
     */
    private static final int NOTIFICATION_ID = 0xdead1336;
    ...
    public void onCreate() {
        ...
        TermuxFloatView floatingWindow = (TermuxFloatView) ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.activity_main_float, null);
    ...
    private void setupNotificationChannel() {
        String channelName = "archriscv-term";
        String channelDescription = "Notifications from archriscv-term";
	...
	String libpath = appContext.getApplicationInfo().nativeLibraryDir;
        executablePath = libpath + "/libsocat.so";
        args = new String[]{executablePath, "pty,rawer,link=/data/user/0/fish4terrisa.archlinux.riscv64/files/environment/tmp/serial4.pty", "stdio,rawer"};

        return new TerminalSession(executablePath, args, env, HOME_PATH, new TerminalSession.SessionChangedCallback() {
            @Override
