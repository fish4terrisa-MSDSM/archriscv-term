...
import fish4terrisa.archlinux.riscv64.terminal.TerminalColors;
...
public final class TerminalActivity extends Activity implements ServiceConnection {
    ...
    private File file;
    private String filePath = "/sdcard/archriscv.qcow2";
        ...
        if (mTermService.getSessions().isEmpty()) {
            if (mIsVisible) {
                Installer.setupIfNeeded(TerminalActivity.this, () -> {
				    ...
				    addNewSession(String.format(Locale.US, "/dev/ttyS%d", 4), TerminalService.SESSION_TYPE_SERIAL, 4);
